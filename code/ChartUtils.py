...
def chart(kind="line", df=None, stacked=False, normalize=False, \
	...
	zvar="", zlabel = "", \
	title=None, grid=True, colormap='NOVAIMS', legend=True, xticks=None, yticks=None, \
	dots = None):
	...
	plt = df_grouped.plot(kind=kind, stacked=stacked, \
			...
			colormap=colormap, figsize=(10,5), title=title, rot=0, fontsize=12, legend=legend, width=0.8,
